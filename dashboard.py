...
db_books = Chroma.from_documents(docs, OpenAIEmbeddings())
...
def get_semantic_recommendations(
    ...
    if category != "All":
        books_recs = books_recs[books_recs["revised_categories"] == category].head(final_top_k)
    else:
...
categories = ["All"] + sorted(books["revised_categories"].unique())
...
with gr.Blocks(theme=gr.themes.Glass()) as dashboard:
    ...
    with gr.Row():
        user_query = gr.Textbox(
            ...
            placeholder="e.g.: A story about revenge"
        )
